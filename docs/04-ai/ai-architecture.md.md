...
### Что делать после вставки

Сохрани файл в Obsidian, но **пока не делай commit**.

Теперь наша документация уже начинает складываться в настоящую архитектурную систему:
